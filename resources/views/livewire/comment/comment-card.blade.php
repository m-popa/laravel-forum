<div class="border border-gray rounded-xl p-5 max-w-full">
    <div class="flex flex-col gap-4">
        ...
        @if ($comment->parent)
            <div class="mt-2">
                ...
                <blockquote class="text-sm bg-surface rounded border-l-4 border-surface pl-3 pr-4 py-3 break-words">
